...
var glob_1 = __importDefault(require("@actions/glob"));
function runCommand(command) {
    return __awaiter(this, void 0, void 0, function () {
        var myOutput, myError, options;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, exec_1.default.exec('node', command.split(' '), options)];
                case 1:
                    _a.sent();
                    console.log(myError);
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    projectId = core_1.default.getInput('srclaunch-project-id');
                    pipelineSecret = core_1.default.getInput('srclaunch-project-pipeline-secret');
                    githubToken = core_1.default.getInput('github-token');
                    context = github_1.default.context;
                    repo = context.repo;
                    pushPayload = github_1.default.context.payload;
                    headCommit = pushPayload.head_commit;
                    octokit = github_1.default.getOctokit(githubToken);
                    return [4 /*yield*/, glob_1.default.create('entities/*.model.js')];
                case 1:
                    globber = _d.sent();
                    _d.label = 2;
                case 2:
